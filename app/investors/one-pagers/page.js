    ...
    <div className="min-h-screen bg-[#0F0F0F] text-white font-['Inter'] antialiased">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-8">
        <div className="text-center max-w-2xl mx-auto">
          <div className="mb-8">
            <div className="w-24 h-[3px] bg-gradient-to-r from-[#8B5CF6] via-[#A855F7] to-[#C084FC] rounded-full mx-auto shadow-lg mb-8" />
          </div>
          ...
          <p className="text-[clamp(18px,2.5vw,24px)] font-light text-[#E2E8F0] leading-relaxed mb-12">
            Condensed summaries for quick investor review. Coming soon with executive summaries, market analysis, and competitive positioning.
          </p>
          
          <Link
            href="/investors"
            className="inline-flex items-center space-x-2 px-8 py-4 bg-gradient-to-r from-[#8B5CF6] to-[#A855F7] text-white font-semibold rounded-lg hover:from-[#7C3AED] hover:to-[#9333EA] transition-all duration-300 shadow-lg"
          >
